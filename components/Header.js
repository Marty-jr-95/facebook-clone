    ...
    return (
        <div className="flex sticky top-0 z-50 bg-white items-center p-2 lg:px-5 shadow-md">
          ...
          <div className="flex items-center">
              ...
              <div className="flex ml-2 bg-gray-100 rounded-full p-2">
                <SearchIcon className="h-6 text-gray-500" />
                <input className="hidden  md:inline-flex ml-2 items-center bg-transparent outline-none text-gray-500 flex-shrink" type="text"  placeholder="Search Facebook"/>
              </div>
